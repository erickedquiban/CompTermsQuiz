...
public class Quizsocialmediaofcomf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quizsocialmediaofcomf);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent int1 = new Intent(Quizsocialmediaofcomf.this, CompActivity.class);
                startActivity(int1);
...
//wag dito
    ...
    private void startQuiz1() {
        Intent intent = new Intent(Quizsocialmediaofcomf.this, Quiz8.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CODE_QUIZ) {
            if (resultCode == RESULT_OK) {
                int score = data.getIntExtra(Quiz8.EXTRA_SCORE, 0);
                if (score > highscore) {
                    updateHighscore(score);
                }
                int recent_score = data.getIntExtra(Quiz8.EXTRA_RECENT_SCORE, 0);
