...
public class QuizhistoryActivity extends  AppCompatActivity {
    private QuestionLibraryhistory mQuestionLibrary1 = new QuestionLibraryhistory();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        high1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent int1 = new Intent(QuizhistoryActivity.this, HighscoreActivity.class);
        ...
        mButtonChoice1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mButtonChoice1.getText() == mAnswer) {
                    ...
                    Toast.makeText(QuizhistoryActivity.this, "", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(QuizhistoryActivity.this, "", Toast.LENGTH_SHORT).show();
                }
            }
